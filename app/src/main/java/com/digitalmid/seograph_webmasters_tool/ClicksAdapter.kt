...
class ClicksAdapter(activity: FragmentActivity?, val currentWeek: List<CurrentWeek>?, val lastWeek: List<LastWeek>, val diff: List<Diff>) : RecyclerView.Adapter<ClicksAdapter.ListItemViewHolder>() {
