...
class ImpressionAdapter(activity: FragmentActivity?, val currentWeek: List<CurrentWeek>?, val lastWeek: List<LastWeek>, val diff: List<Diff>) : RecyclerView.Adapter<ImpressionAdapter.ListItemViewHolder>() {
    ...
    class ListItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(get: CurrentWeek?) {
            imression = itemView.findViewById<TextView>(R.id.tv_values)
            ...
            imression!!.text = get!!.getImpressions().toString()

        }

        fun bindItemsLastWeek(get: LastWeek?) {
            imression = itemView.findViewById<TextView>(R.id.tv_values1)
