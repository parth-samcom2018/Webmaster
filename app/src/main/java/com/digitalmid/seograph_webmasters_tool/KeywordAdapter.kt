...
class KeywordAdapter(activity: FragmentActivity?, val currentWeek: List<CurrentWeek>?, val lastWeek: List<LastWeek>, val diff: List<Diff>) : RecyclerView.Adapter<KeywordAdapter.ListItemViewHolder>() {
    ...
    class ListItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItemsLastWeek(get: LastWeek?) {
            ...
            keyword = itemView.findViewById<TextView>(R.id.tv_key1)
